...
define(function (require, exports, module) {
  ...
  function _inserthtmltemplate() {
    ...
    var htmltemplate = "<!doctype html>\n<html class='no-js' lang='en'>\n\n<head>\nindent-size<meta charset='utf-8' />\n" +
        ...
        "indent-size<script src='https://cdnjs.cloudflare.com/ajax/libs/foundation/boots-version/js/vendor/modernizr.js'></script>\n" +
        "</head>\n\n<body>\n" +
        ...
        "indent-sizeindent-size</div>\n" +
        "indent-size</div>\n\n" +
        "indent-size<script src='https://cdnjs.cloudflare.com/ajax/libs/foundation/boots-version/js/vendor/jquery.js'></script>\n" +
        "indent-size<script src='https://cdnjs.cloudflare.com/ajax/libs/foundation/boots-version/js/foundation/foundation.min.js'></script>\n" +
        "indent-size<script>\n" +
