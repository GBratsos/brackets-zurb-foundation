...
define(function (require, exports, module) {
  "use strict";
  /*
   * Simple extension that adds an "Edit > New Zurb Foundation Document" menu item
  ...
  /**
   * @private
   * Get the latest stable Zurb Foundation version using the GitHub API
   */
